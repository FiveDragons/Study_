...
if 90 < score:
    ...
    print("F")
# 나는 map(int, input())을 할 경우 input을 통해 나온 값이 str형이 아닌 int형으로 바뀌는 것인줄 알았지만
# 사실은 int(intput()) 이라고 해야 int형으로 바뀐 것이다.
# 또한 if문을 사용할때 "if(식):" 이 아닌 "if 식:" 으로 해도 된다.
'''
...
# 이미지 : https://www.acmicpc.net/problem/14681
